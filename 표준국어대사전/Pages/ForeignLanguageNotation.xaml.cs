...
namespace 표준국어대사전.Pages
{
    ...
    /// </summary>
    public sealed partial class ForeignLanguageNotation : Page
    {
        public ForeignLanguageNotation()
        {
            this.InitializeComponent();

            WebViewMain.Navigate(new Uri("http://korean.go.kr/front/page/pageView.do?page_id=P000104&mn_id=97"));
        }
