...
namespace 표준국어대사전.Pages
{
    ...
    /// </summary>
    public sealed partial class KoreanRomanization : Page
    {
        public KoreanRomanization()
        {
            this.InitializeComponent();

            WebViewMain.Navigate(new Uri("http://korean.go.kr/front/page/pageView.do?page_id=P000148&mn_id=99"));
        }
